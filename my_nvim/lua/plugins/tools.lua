	...
	{ dir = "~/.config/nvim/lua/local/term",
		...
		keys = {
			{ "<C-x>", "<C-\\><C-N>", mode = "t", desc = "Terminal scape to normal mode"},
			{
				...
				end, mode = {"t"}, desc = "Close Terminal"
			},
			{
				"<leader>h",
				function ()
			...
			},
			{
				...
				end, desc = "New vertical termomal",
			},
			{
				"<A-g>",
				function ()
				...
				end, mode = {"t", "n"}, desc = "Terminal Open Lazygit on toggle float mode",
			},
			{
				"<A-v>",
				function ()
					require("local.term").toggle({
						pos = "vsp", id = "vtoggleTerm"
					})
				end, mode = {"t", "n"}, desc = "Terminal toggleable vertical"
			},
			{
				"<A-h>",
				function ()
					require("local.term").toggle({
						pos = "sp", id = "htoggleTerm"
					})
				end, mode = {"t", "n"}, desc = "Terminal toggleable horizontal"
			},
			{
				"<A-i>",
				function ()
				...
				end, mode = {"t", "n"}, desc = "Terminal float toggleable"
			},
		}
	},
