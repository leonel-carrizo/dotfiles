...
map("v", "<leader>oe", ":Obsidian extract_note<CR>", { desc = "Obsidian Extract selected text into note" })
map("n", "<leader>oo", ":Obsidian open<CR>", { desc = "Obsidian Open Curren Note in App" })
map("n", "<leader>oq", ":Obsidian quick_switch<CR>", { desc = "Obsidian quickly switch to another vault note" })
map("n", "<leader>ott", ":Obsidian template<CR>", { desc = "Obsidian insert template (picker)" })
map("n", "<leader>otn", ":Obsidian new_from_template", { desc = "Obsidian new note from template (picker)" })
map("n", "<leader>of", ":Obsidian follow_link vsplit<CR>", { desc = "Obsidian open reference under the cursor (vsplit)" })
map("n", "<leader>ob", ":Obsidian backlinks<CR>", { desc = "Obsidian list of references to the current buffer" })
